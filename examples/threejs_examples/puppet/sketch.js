...
function gotBodies(data) {
	...
	if (canvas !== null) {
		joints[0].position.set(data.joints[3].cameraX*cw, data.joints[2].cameraY*ch, 0);
		joints[1].position.set(data.joints[0].cameraX*cw, data.joints[1].cameraY*ch, 0);
		joints[2].position.set(data.joints[23].cameraX*cw, data.joints[23].cameraY*ch, 0);
		joints[3].position.set(data.joints[9].cameraX*cw, data.joints[9].cameraY*ch, 0);
		joints[4].position.set(data.joints[21].cameraX*cw, data.joints[21].cameraY*ch, 0);
		joints[5].position.set(data.joints[5].cameraX*cw, data.joints[5].cameraY*ch, 0);
		joints[6].position.set(data.joints[19].cameraX*cw, data.joints[19].cameraY*ch, 0);
		joints[7].position.set(data.joints[17].cameraX*cw, data.joints[17].cameraY*ch, 0);
		joints[8].position.set(data.joints[15].cameraX*cw, data.joints[15].cameraY*ch, 0);
		joints[9].position.set(data.joints[13].cameraX*cw, data.joints[13].cameraY*ch, 0);
