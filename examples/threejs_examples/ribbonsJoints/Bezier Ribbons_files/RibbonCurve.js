var RibbonCurve = function(pStartPt, pEndPt, pControlPt, pwidth, presolution, pMaterial, ribbonGroup) {
...
RibbonCurve.prototype.removeSegment = function() {
	if(this.quads.length > 0) {
		...
		this.ribbonGroup.ribbonHolder.remove(quad);
	}
}
...
RibbonCurve.prototype.addSegment = function() {
	...
	this.ribbonGroup.ribbonHolder.add(quad);
